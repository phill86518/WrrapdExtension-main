...
function wrrapd_render_orders_studio( array $orders, array $overlays ) {
	...
	echo '<style>
.wrrapd-amz-root{--bx:#4b5563;--bx-soft:#6b7280;--bx-line:#9ca3af;--bx-bg:#f3f4f6;--ink:#111827;--muted:#4b5563;--wr-font:"DM Sans",system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;--wr-display:"Fraunces",Georgia,serif;width:100%;max-width:min(100%,960px);margin:0 auto 1rem;padding:0 .35rem;font-family:var(--wr-font);font-size:.72rem;line-height:1.25;color:var(--ink);-webkit-font-smoothing:antialiased;box-sizing:border-box;}
.wrrapd-amz-root *,.wrrapd-amz-root *::before,.wrrapd-amz-root *::after{box-sizing:border-box;}
.wrrapd-amz-search{margin:0 0 .35rem;}
.wrrapd-amz-search input{width:100%;max-width:min(100%,360px);padding:.22rem .45rem;border-radius:6px;border:1px solid var(--bx);font-size:.68rem;background:#fff;font-family:var(--wr-font);color:var(--ink);}
.wrrapd-amz-search input:focus{outline:2px solid var(--bx-line);outline-offset:1px;border-color:var(--bx);}
.wrrapd-amz-order{background:#fff;border:1px solid var(--bx);border-radius:6px;margin-bottom:.5rem;box-shadow:0 1px 3px rgba(0,0,0,.06);overflow:hidden;}
.wrrapd-amz-bar{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:flex-start;gap:.25rem .75rem;padding:.35rem .5rem;background:var(--bx-bg);border-bottom:1px solid var(--bx);}
.wrrapd-amz-bar-lbl{font-size:.58rem;font-weight:700;font-family:var(--wr-display);color:var(--muted);letter-spacing:.06em;text-transform:uppercase;}
.wrrapd-amz-bar-date{margin-top:0;font-size:.78rem;font-weight:700;font-family:var(--wr-display);color:var(--ink);}
.wrrapd-amz-bar-onum{margin-top:0;font-size:.74rem;font-weight:700;color:var(--ink);text-align:right;font-family:var(--wr-display);}
...
.wrrapd-amz-design-col{flex:0 0 118px;width:118px;max-width:118px;min-height:9rem;padding:.35rem .28rem;border-right:1px solid var(--bx);background:#f9fafb;display:flex;flex-direction:column;justify-content:flex-end;align-items:center;}
...
.wrrapd-amz-fields-col{flex:1 1 auto;min-width:0;width:100%;padding:.32rem .5rem .4rem;display:flex;flex-direction:column;align-items:stretch;gap:.2rem;text-align:left;background:#fff;}
@media(max-width:560px){.wrrapd-amz-line-inner{flex-direction:column;}.wrrapd-amz-design-col{flex:none;max-width:none;width:100%;min-height:0;border-right:none;border-bottom:1px solid var(--bx);}}
.wrrapd-amz-f label{display:block;font-size:.55rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);margin-bottom:.06rem;font-family:var(--wr-font);}
.wrrapd-amz-f input[type=text],.wrrapd-amz-f select{width:100%;max-width:100%;padding:.18rem .35rem;border-radius:5px;border:1px solid var(--bx);font-size:.65rem;font-family:var(--wr-font);background:#fff;line-height:1.2;color:var(--ink);}
.wrrapd-amz-f select{cursor:pointer;accent-color:var(--bx-soft);}
.wrrapd-amz-f select:focus,.wrrapd-amz-f input[type=text]:focus{outline:2px solid var(--bx-line);outline-offset:0;border-color:var(--bx);}
.wrrapd-amz-f-datewrap{max-width:11rem;width:100%;}
.wrrapd-amz-f-datewrap input[type=date]{width:100%;max-width:11rem;padding:.14rem .28rem;border-radius:5px;border:1px solid var(--bx);font-size:.64rem;font-family:var(--wr-font);background:#fff;color:var(--ink);accent-color:var(--bx-soft);}
.wrrapd-amz-f-datewrap input[type=date]:focus{outline:2px solid var(--bx-line);border-color:var(--bx);}
.wrrapd-amz-f-hint{font-size:.55rem;color:var(--muted);margin-top:.06rem;line-height:1.2;}
...
.wrrapd-amz-rowcheck{display:flex;align-items:center;gap:.3rem;font-size:.62rem;font-weight:600;color:var(--ink);margin:.06rem 0;}
.wrrapd-amz-rowcheck input{width:15px;height:15px;accent-color:var(--bx-soft);margin:0;}
.wrrapd-amz-rowcheck label{margin:0;text-transform:none;letter-spacing:0;font-size:.62rem;}
.wrrapd-amz-savebar{margin-top:.12rem;padding-top:.22rem;border-top:1px dashed var(--bx-line);display:flex;justify-content:flex-start;}
.wrrapd-amz-save{background:#374151;color:#fff;border:1px solid #111827;border-radius:6px;padding:.24rem .85rem;font-weight:700;font-size:.64rem;cursor:pointer;font-family:var(--wr-display);letter-spacing:.02em;}
.wrrapd-amz-save:hover{background:#4b5563;}
