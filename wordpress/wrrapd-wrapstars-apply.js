(function () {
	/* wrrapd-wrapstars-apply.js v24 — WrapStars wrap only (delivery / PO-box questions removed); custom-print wording. */
	var TIDBITS = [
	...
	function buildReview() {
		...
		var rows = [
			...
			['dedicated_wrap_workspace', 1], ['has_large_format_printer', 1], ['printer_size', 1],
			['gift_wrapping_experience', 2], ['business_structure', 2],
			['bank_account_ready', 3], ['comfortable_video_monitoring', 3], ['delivery_proof_ready', 3], ['gov_id', 3],
			['why_wrapstar', 4]
		];
		var html = '<dl>';
