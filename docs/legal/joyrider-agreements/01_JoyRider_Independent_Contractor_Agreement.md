<!-- Branded view (Wrrapd logo header + Fraunces): branded/01_JoyRider_Independent_Contractor_Agreement.html -->

# JOYRIDER INDEPENDENT CONTRACTOR AGREEMENT
...
2.4 Contractor may accept or decline work windows as the JoyRider App permits, may provide similar services to others, and is not guaranteed any minimum hours, volume, or income.

2.5 Contractor shall not subcontract, assign, or delegate performance of the Services without Wrrapd’s prior written consent.
...
## 4. Scope of Services (Logistics Only)

4.1 Contractor’s role is **pickup, transfer, floral pickup when assigned, barcode scan, and delivery**. Contractor does **not** wrap gifts and shall not open a finished wrap to read a packing slip.

4.2 As assigned in the JoyRider App, Contractor agrees to:
...
## 7. JoyRider App and Platform

7.1 **License.** Subject to this Agreement, Wrrapd grants Contractor a limited, non-exclusive, non-transferable, revocable license to download, install, and use the JoyRider App and related Platform tools solely to perform the Services. The JoyRider App is licensed, not sold.

7.2 **Account and credentials.** Contractor shall maintain only one JoyRider App account (unless Wrrapd approves otherwise), keep credentials confidential, not share the account, and promptly notify Wrrapd of unauthorized access.
...
7.6 **Prohibited App conduct.** Contractor shall not reverse engineer the App (except as law prohibits such restriction), interfere with security, use bots or unauthorized automation, or upload malware or unlawful content.
...
## 10. Vehicle, License, and Safety

10.1 Contractor shall maintain a valid driver’s license, an eligible vehicle, and legally required automobile insurance, and shall provide proof upon request. License suspension or required-insurance lapse is grounds for immediate deactivation.

10.2 Contractor shall drive lawfully and safely, shall not drive while impaired, and shall follow published JoyRider safety standards.
...
12.1 **Confidential Information** includes all non-public information Contractor obtains in connection with the Services, Platform, or JoyRider App, including without limitation:
...
Exclusions for publicly available information, prior rightful possession, and independent development apply as under customary confidentiality practice, provided Contractor does not itself cause public disclosure.

12.2 Contractor shall not disclose Confidential Information to any third party except to Wrrapd personnel with a need to know, to professional advisors under confidentiality for tax/legal advice, or as required by law with prompt notice to Wrrapd where legally permitted.

12.3 Contractor shall use Confidential Information **solely** to complete assigned stops. Contractor shall not scrape or bulk-export data, use Confidential Information to compete with Wrrapd, reverse engineer the App beyond ordinary use, or retain recipient addresses after delivery longer than needed for the stop (except tax records subject to this Section 12).
...
15.1 Contractor shall follow the JoyRider Code of Conduct and Safety Guidelines and published Platform standards. Wrrapd may suspend or deactivate App access for material breach, safety issues, failed scans or proof, screening issues, or ratings below published thresholds.

---

## 16. Communications; Response Time

While Contractor has active or accepted windows, or has indicated availability in the JoyRider App, Contractor shall monitor and respond to Wrrapd communications (in-App, email, or SMS as consented) within twenty-four (24) hours, or sooner if a live stop so requires.
...
18.1 Any dispute arising out of or relating to this Agreement, the Companion Documents, the JoyRider App, compensation, termination, or Contractor’s relationship with Wrrapd shall be resolved exclusively under the separate **Mutual Arbitration Agreement** executed concurrently herewith.

18.2 This Agreement is governed by the laws of the **State of Florida**, without regard to conflict-of-law principles that would require another jurisdiction’s laws, except as the Federal Arbitration Act governs the Mutual Arbitration Agreement.

---

## 19. Entire Agreement; Amendments; Severability

19.1 This Agreement, together with the Companion Documents and Compensation Schedule then in effect, constitutes the entire agreement regarding the Services and supersedes prior proposals relating thereto.

19.2 Wrrapd may update Platform policies and the Compensation Schedule prospectively. Core Agreement amendments require electronic acceptance or written agreement.

19.3 If any provision is held unenforceable, the remainder continues in effect. Contractor may not assign without Wrrapd’s consent; Wrrapd may assign to an affiliate or successor.
